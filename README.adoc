...
{github-url}/sorairolake/Sysexits.NET[Sysexits.NET]::
  ...
  A port of {github-url}/sorairolake/sysexits-rs[sysexits-rs] for .NET.
...
{github-url}/sorairolake/Sysexits.jl[Sysexits.jl]::
  ...
  A port of {github-url}/sorairolake/sysexits-rs[sysexits-rs] for Julia.
...
{github-url}/sorairolake/sysexits-zig[sysexits-zig]::
  ...
  A port of {github-url}/sorairolake/sysexits-rs[sysexits-rs] for Zig.
